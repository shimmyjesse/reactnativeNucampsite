...
const MainNavigator = createDrawerNavigator(
    ...
    {
        initialRouteName: 'Home', //  explicitly set to Home, added after LoginComponent, ensuring our landing doesn't start on whatever is first on list
...
class Main extends Component {
    ...
    componentWillUnmount() {
        this.unsubscribeNetInfo();  //stop listening for connection changes when the Main Component unmounts.
    }
